...
- `/agent/brain/creative-strategy-guidance/hook-generation--standards.md` for hook quality and pressure checks
- `/agent/brain/creative-strategy-guidance/creative-strategy-engine.md` only when the brief needs audience, stage, or context adaptation or clearer strategic mapping
...
- If the user did not provide a hook, generate it inline using `/agent/brain/creative-strategy-guidance/hook-generation--standards.md`.
