...
`/agent/brain/installed-packages/meta-and-voc-onboarding/meta-onboarding-rules/meta-analysis-account-context.md` - merge from that file,
...
- Create `/agent/brain/brands/<brand>/integrations/meta/` if it does not exist. Save the filled
...
naming_decoder: </agent/brain/brands/<brand>/integrations/meta/naming-decoder.json — or null when no convention>
```
...
(`/agent/brain/installed-packages/meta-and-voc-onboarding/motion-cli-data-query-guide.md`); this table says which command
...
decoder saved at `/agent/brain/brands/<brand>/integrations/meta/naming-decoder.json`. Do not embed the full decoder in
...
- Decoder file: `</agent/brain/brands/<brand>/integrations/meta/naming-decoder.json — written and indexed | not needed (no convention)>`
...
On confirmation, write this into Field 10's own field section of `/agent/brain/brands/<brand>/integrations/meta/account-context.md`, like every other field
...
- Written to: `/agent/brain/brands/<brand>/integrations/meta/account-context.md`
