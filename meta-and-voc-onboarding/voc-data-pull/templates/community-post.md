...
Paths: `/agent/brain/<brand>/integrations/voice-of-customer/reddit/post-<external_id>.md` for posts,
`/agent/brain/<brand>/integrations/voice-of-customer/reddit/comment-<external_id>.md` for pulled comments
