...
Paths: `/agent/brain/brands/<brand>/customer-feedback/reddit/post-<external_id>.md` for posts,
`/agent/brain/brands/<brand>/customer-feedback/reddit/comment-<external_id>.md` for pulled comments
