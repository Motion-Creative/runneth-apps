...
Motion workspace this pull belongs to, lowercased with spaces as hyphens ("Huel EU" ->
`huel-eu`). **Every pull is scoped to one workspace.** The workspace folder is the boundary that
