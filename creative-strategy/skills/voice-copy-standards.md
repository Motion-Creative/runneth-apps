---
name: voice-copy-standards
description: >
  Enforces Alysha's human-sounding, spoken-first copy standards across all written outputs - scripts, briefs, hooks, captions, LinkedIn posts, and any other copy. Use this skill any time you are writing, editing, reviewing, or rewriting any copy for Alysha. Trigger automatically on: UGC scripts, talking head scripts, ad scripts, creative briefs, hooks, captions, LinkedIn posts, TikTok captions, Instagram captions, email copy, or any request involving write this for me, rewrite this, make this sound better, or does this sound human. If copy is being generated, this skill is active. No exceptions.
---

# Voice & Copy Standards

This skill defines the rules for all copy Alysha produces or approves — scripts, briefs, hooks, captions, posts, emails. The north star: **if a real person filming on their phone wouldn't say it, cut it.**
