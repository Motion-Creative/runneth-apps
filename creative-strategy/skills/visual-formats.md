...
Messaging Angle (Creative Strategy Engine)
    ↓
Creative Mechanic (Creative Mechanics Skill)
    ↓
Hook (Hook Writing Skill + Hook Tactics Skill)
    ↓
Visual Format ← YOU ARE HERE
```

**However — format and mechanic are bidirectional.** You can start with a format and work backward to find the right mechanic, or start with a mechanic and find the format that best delivers it. Both workflows are valid. When you've chosen a format, consult the Creative Mechanics skill to complete the concept.
...
**Funnel stage shorthand used in this skill:**
