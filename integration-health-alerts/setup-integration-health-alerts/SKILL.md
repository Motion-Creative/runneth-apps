...
triggers:
  phrases:
    ...
    - "reconfigure integration health"
    - "personalize integration health alerts"
  intent: "User wants to configure or re-configure integration health alerts for their sandbox"
  context: "integration-health-alerts use case is installed"
---

# Setup: integration-health-alerts
...
Return:
```
✅ Integration health alerts are set up.
...
I'll monitor all connected integrations and post in #<channel-name> if anything breaks. No action needed from you — I'll reach out when something needs your attention.
```
