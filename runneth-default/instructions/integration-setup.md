...
When a user gives standing instructions about an integration, save or update the matching file under `/agent/brain/integrations/`. Save only durable customer-specific knowledge, such as:
