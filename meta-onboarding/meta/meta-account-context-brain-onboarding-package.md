...
- **Required context fields** — the field sections: Field 1 — Sources of truth ·
  ...
  performance metrics · Field 9 — Targets, thresholds and decision rules ·
...
`/agent/brain/meta-onboarding/meta-onboarding-rules/meta-analysis-account-context.md` - merge from that file,
...
(`/agent/brain/meta-onboarding/motion-cli-data-query-guide.md`); this table says which command
...
## Field 8 — Creative performance metrics
