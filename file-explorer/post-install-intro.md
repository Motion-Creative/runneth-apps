...
## What just opened up
You can now browse Runneth's brain like a folder on your laptop. Every file, every saved note, every routine spec, every config, openable and editable in the same window as the chat. What you see is what your Runneth sees.
...
## Compounds with
- **conversation-manager:** Same kind of openable surface; one for chats, one for files.
- **routine-storage-audit:** When the audit flags misplaced data, open the explorer to inspect the actual files.
