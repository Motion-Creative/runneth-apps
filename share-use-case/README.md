...
**Anyone can package a use case from their sandbox and submit it to the shared library for others to discover and install.**

Once installed, a sandbox can contribute back to the marketplace. Build a use case, run this skill, and get a zip with step-by-step upload instructions and a pre-filled PR description — ready to submit for review.
