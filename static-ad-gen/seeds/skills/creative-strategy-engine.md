...
Awareness Stages (5 stages from unaware → most aware)
    ↓
Creative Mechanic (How the concept delivers the truth — Creative Mechanics Skill)
    ↓
Hook (Opening line that triggers the mechanic — Hook Writing Skill + Hook Tactics Skill)
    ↓
...
**For the full mechanic library**, refer to the **Creative Mechanics Skill.**
...
- **Understand the framework** before executing with other skills
...
- Once strategy is clear, execution skills take over
- Hook Writing Skill creates the hooks
- Script Writing Skill creates the scripts
- Visual Format skills handle production

### This Skill Does NOT

- ❌ Write hooks (that's Hook Writing Skill)
- ❌ Write scripts (that's Script Writing Skill)
- ❌ Create specific ad copy (that's execution skills)
...
It does NOT provide:
- Tactical hook writing (use Hook Writing Skill)
- Script creation (use Script Writing Skill)
- Specific ad copy (use execution skills)
...
Defines messaging angle for pain × persona at awareness stage
    ↓
Creative Mechanics Skill
    ↓
Defines how the concept delivers the truth
    ↓
Hook Writing Skill + Hook Tactics Skill
    ↓
...
4. Choose the creative mechanic (Creative Mechanics Skill)
5. THEN execute with tactical skills (Hook Writing, Hook Tactics, Hook Voice Patterns, Script Writing, etc.)
